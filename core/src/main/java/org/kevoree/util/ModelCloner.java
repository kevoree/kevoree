...
/**
 * This model cloner is cloning well unlike org.kevoree.modeling.api.ModelCloner :)
...
public class ModelCloner {
    ...
    private KMFContainer attributesClone(KMFContainer elem) {
        ...
        elem.visitAttributes((value, refInParent, parent) -> {
            if (value != null) {
                if (value instanceof ArrayList) {
                    ArrayList list = (ArrayList) value;
                    ArrayList<Object> clonedList = new ArrayList<>(list.size());
