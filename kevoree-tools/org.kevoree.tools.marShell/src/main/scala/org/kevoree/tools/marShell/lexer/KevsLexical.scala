...
class KevsLexical extends Lexical with KevsTokens {
  ...
  val reserved : HashSet[String] = HashSet("tblock","addComponent","removeComponent","addNode","removeNode","addChannel","removeChannel","bind","unbind","addGroup","removeGroup","createComponentType","createChannelType","addPortType")
