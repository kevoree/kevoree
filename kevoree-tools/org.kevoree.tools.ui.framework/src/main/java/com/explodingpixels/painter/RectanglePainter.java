...
/**
 * An implemenation of {@link MacWidgetsPainter} that fills the given width and height of a {@link java.awt.Component} with a solid color.
 */
public class RectanglePainter implements MacWidgetsPainter<Component> {
    ...
    /**
     * Creates a {@link MacWidgetsPainter} that fills a {@link java.awt.Component} with the given {@link java.awt.Color}.
