...
public class WindowUtils {
	...
	/**
	 * Try's to make the given {@link java.awt.Window} non-opqaue (transparent) across
	 ...
	 * given {@link java.awt.Window}. This will only work when running with JRE 6 update
	...
	/**
	 * Creates and installs a {@link java.awt.event.WindowFocusListener} on the given
	 * {@link java.awt.Window} which calls the {@code Window}'s {@code repaint()} method
	...
	/**
	 * Installs a {@link java.awt.event.WindowFocusListener} on the given {@link javax.swing.JComponent}'s
	 * parent {@link java.awt.Window}. If the {@code JComponent} doesn't yet have a
	...
	/**
	 * Installs a listener on the given {@link javax.swing.JComponent}'s parent
	 * {@link java.awt.Window} that repaints the given component when the parent window's
	...
	/**
	 * Creates an {@link javax.swing.event.AncestorListener} that installs a weakly referenced
	 * version of the given {@link java.awt.event.WindowFocusListener} when the given
	 * {@link javax.swing.JComponent}'s parent changes.
	 */
	...
	/**
	 * Creates a {@link java.awt.event.WindowFocusListener} that calls repaint on the given
	 * {@link javax.swing.JComponent} when focused gained or focus lost is called.
	 */
