...
public class HudCheckBoxUI extends BasicCheckBoxUI {
    ...
    private class CheckIcon implements Icon {
        ...
        /**
         * Draws the check mark if {@link javax.swing.ButtonModel#isSelected} returns true.
         */
         ...
         * {@link javax.swing.ButtonModel#isPressed} state. Note that part of the check will be drawn outside
