...
/**
 * A category in a {@link com.explodingpixels.macwidgets.SourceList}. {@code SourceListCategory}s are top level containers for
 * {@link com.explodingpixels.macwidgets.SourceListItem}s. {@code SourceListCategory}s are text only, and rendered in full caps
...
public class SourceListCategory implements TextProvider {
    ...
    /**
     * Gets the number of child {@link com.explodingpixels.macwidgets.SourceListItem}s that are part of this category.
     *
    ...
    /**
     * Returns {@code true} if the given {@link com.explodingpixels.macwidgets.SourceListItem} is contained by this category, to
    ...
    /**
     * Gets a list of this {@code SourceListCategory}'s {@link com.explodingpixels.macwidgets.SourceListItem}s.
     *
