...
class KevS2CompressedKevsTest extends KevSTestSuiteHelper {
  ...
  @Test def update1Period() {
    ...
    println(result)
    assert(result == "b{udi:t1:period=100,/};")
  }
  ...
  @Test def update1Pin() {
    ...
    val result = KevScriptWrapper.generateKevScriptCompressed(baseScript)
    println(result)
    assert(result == "b{udi:DigitalLight138771701:pin=10,/};")
  }
  ...
  @Test def update2Param() {
    ...
    val result = KevScriptWrapper.generateKevScriptCompressed(baseScript)
    println(result)
    assert(result == "b{udi:DigitalLight138771701:pin=10,/udi:t1:period=100,/};")
  }
  ...
  @Test def update_1ain_1abi() {
    ...
    val result = KevScriptWrapper.generateKevScriptCompressed(baseScript)
    println(result)
    assert(result == "b{ain:DigitalLight1925293585:DigitalLight:pin=10,/abi:DigitalLight1925293585:hub846068439:toggle/};")
  }
