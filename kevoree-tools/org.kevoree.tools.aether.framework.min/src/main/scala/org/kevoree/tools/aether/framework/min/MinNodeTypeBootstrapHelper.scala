...
class MinNodeTypeBootstrapHelper extends NodeTypeBootstrapHelper {
  ...
  override def resolveArtifact(artId: String, groupId: String, version: String, repos: List[String]): File = AetherUtil.resolveMavenArtifact(artId, groupId, version, repos)


  override def resolveArtifact(artId: String, groupId: String, version: String, extension : String, repos: List[String]): File = AetherUtil.resolveMavenArtifact(artId, groupId, version, extension, repos)
