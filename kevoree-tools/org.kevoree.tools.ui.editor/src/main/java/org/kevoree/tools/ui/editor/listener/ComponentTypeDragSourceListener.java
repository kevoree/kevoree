 ...
 */
public class ComponentTypeDragSourceListener extends DragSourceAdapter implements DragSourceMotionListener, DragGestureListener {

    private KevoreeUIKernel kernel;
    private ComponentTypePanel flightComponent;
    private DragSource dragSource;
    private DragGestureEvent dragOriginEvent;
    private Transferable transferable;
    private Point origin2;
    private ComponentPanel tempPanel= new ComponentPanel();
     ...
     * @param _panel
     */
    public ComponentTypeDragSourceListener(ComponentTypePanel _ct, KevoreeUIKernel _kernel) {
        //this.panel = _panel;
