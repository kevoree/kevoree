 ...
 */
public class NodeTypeDragSourceListener extends DragSourceAdapter implements DragSourceMotionListener, DragGestureListener {

    private KevoreeUIKernel kernel;
    private NodeTypePanel flightComponent;
    private DragSource dragSource;
    private DragGestureEvent dragOriginEvent;
    private Transferable transferable;
    private Point origin2;
    private NodeTypePanel tempPanel= new NodeTypePanel();
     ...
     * @param _panel
     */
    public NodeTypeDragSourceListener(NodeTypePanel _ct, KevoreeUIKernel _kernel) {
