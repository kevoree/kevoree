...
import org.kevoree.editor.component.creator.commands.CreateComponentCommand;
 ...
 * @author gnain
 */
public class LibraryModelElementDropTargetListener extends DropTargetAdapter {

    private LibraryModelElement modelElement;
    private DropTarget dropTarget;
    private JPanel panel;
    private JPanel flyingComponent;
    private Kernel kernel;

    public LibraryModelElementDropTargetListener(Kernel k, LibraryModelElement element) {
    ...
    public void dragOver(DropTargetDragEvent dtde) {
        try {
            ...
            if (trans.isDataFlavorSupported(TransferableArt2Element.art2ElementFlavor)) {
                if (dtde.getTransferable().getTransferData(TransferableArt2Element.art2ElementFlavor) instanceof Component) {
            ...
            Logger.getLogger(LibraryModelElementDropTargetListener.class.getName()).log(Level.SEVERE, null, ex);
        ...
        try {
            ...
            if (event.isLocalTransfer()) {
                ...
                if (trans.isDataFlavorSupported(TransferableArt2Element.art2ElementFlavor)) {
                    ...
                    command.setParentModelElement(kernel.getModelMapper().getModelElement(modelElement));
