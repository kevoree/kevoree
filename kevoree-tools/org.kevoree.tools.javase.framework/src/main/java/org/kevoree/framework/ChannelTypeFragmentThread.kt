...
trait ChannelTypeFragmentThread : KevoreeChannelFragment,KInstance,ChannelFragment {
  ...
  override fun remoteDispatch(msg: Message): Object = {
  ...
  fun isStarted: Boolean = ct_started

  override fun getBindedPorts(): java.util.List[KevoreePort] = {
    import scala.collection.JavaConversions._
    portsBinded.values.toList
  }

  //OVERRIDE BY FACTORY
  override fun getOtherFragments(): java.util.List[KevoreeChannelFragment] = {
    import scala.collection.JavaConversions._
    fragementBinded.values.toList
  }

  override fun forward(delegate: KevoreeChannelFragment, inmsg: Message): Object = {
    val msg = inmsg.clone
  ...
  override fun forward(delegate: KevoreePort, inmsg: Message): Object = {
    val msg = inmsg.clone
    if (msg.inOut.booleanValue) {
  ...
  fun getDictionary: java.util.HashMap[String, Object]

  fun getName: String

  fun kUpdateDictionary(d: java.util.HashMap[String, AnyRef], cmodel: ContainerRoot): java.util.HashMap[String, AnyRef] = {
    try {
      import scala.collection.JavaConversions._
  ...
  /* LifeCycle Method */
  fun startChannelFragment(): Unit = {}

  fun stopChannelFragment(): Unit = {}

  fun updateChannelFragment: Unit = {}
