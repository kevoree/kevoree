 ...
 */
public class NewComponentTypeAction extends CreateTemplateInPackageAction<PsiElement> implements DumbAware {
    ...
    protected void buildDialog(Project project, PsiDirectory psiDirectory, CreateFileFromTemplateDialog.Builder builder) {
        ...
        builder.addKind("New Kevoree Component", KevIcons.KEVS_ICON_16x16, "main.java");
        /*
    ...
    protected String getActionName(PsiDirectory psiDirectory, String s, String s2) {
        return KevBundle.message("new.component.lib.action.text");
    }
}
