 ...
 */
public class NewChannelTypeAction extends CreateTemplateInPackageAction<PsiElement> implements DumbAware {

    public NewChannelTypeAction() {
    ...
    protected String getActionName(PsiDirectory psiDirectory, String s, String s2) {
        return KevBundle.message("new.channel.lib.action.text");
    }
}
