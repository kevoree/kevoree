...
class _01_FromScratchChannelTypeTest extends JUnitSuite with CompilationUnitHelpers{

  val generationLocation : String = "target/test-classes/generated/ChannelType"
 ...
 def recursiveDelete(dirPath : File) {
  ...
  def BaseComponentTypeTest() {
    ...
    val model = KevoreeXmiHelper.load(this.getClass.getClassLoader.getResource("models/defaultChannels.kev").getPath)
