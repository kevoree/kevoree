...
class _03_FromScratchGroupTypeTest extends JUnitSuite with CompilationUnitHelpers{

  val generationLocation : String = "target/test-classes/generated/GroupeType"
  ...
  def BaseComponentTypeTest() {
    ...
    val model = KevoreeXmiHelper.load(this.getClass.getClassLoader.getResource("models/groupTypes.kev").getPath)
