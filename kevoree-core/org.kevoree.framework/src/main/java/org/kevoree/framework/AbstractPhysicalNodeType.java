...
public abstract class AbstractPhysicalNodeType implements KevoreeAdaptationDeployService {

    public abstract void push(String physicalNodeName, ContainerRoot root, BundleContext context);
