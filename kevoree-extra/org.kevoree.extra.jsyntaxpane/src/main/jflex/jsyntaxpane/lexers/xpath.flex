...
<YYINITIAL> {
  {VariableReference} { return token(TokenTypes.IDENTIFIER); }
  {Number} { return token(TokenTypes.NUMBER); }
  {AxisName} { return token(TokenTypes.TYPE); }
  ...
  {Operator} { return token(TokenTypes.OPERATOR); }
  {NodeType} { return token(TokenTypes.KEYWORD); }
  {XPathFunction} { return token(TokenTypes.KEYWORD2); }
  {FunctionName} { return token(TokenTypes.IDENTIFIER); }
  {NameTest} { return token(TokenTypes.IDENTIFIER); }
