...
<YYINITIAL> {
  ...
  {OpenTagStart}                 {
                                     yybegin(TAG);
                                     return token(TokenTypes.TYPE, TAG_OPEN);
                                 }
  {CloseTag}                       {   return token(TokenTypes.TYPE, TAG_CLOSE); }
  {CommentStart}                 {
                                     yybegin(COMMENT);
...
<TAG> {
  ...
  {OpenTagClose}                 {
                                     yybegin(YYINITIAL);
                                     return token(TokenTypes.TYPE, TAG_CLOSE);
}

  {OpenTagEnd}                   {
                                     yybegin(YYINITIAL);
                                     return token(TokenTypes.TYPE);
                                 }
}
