...
<YYINITIAL> {
  ...
  "unless"                       |
  "next"                         |
  "return"                       { return token(TokenTypes.KEYWORD); }
  ...
  "until"                        |
  "do"                           |
  "if"                           { return token(TokenTypes.KEYWORD,  WORD); }

  "end"                          { return token(TokenTypes.KEYWORD, -WORD); }
  ...
  "false"                        |
  "__FILE__"                     |
  "__LINE__"                     {  return token(TokenTypes.TYPE);  }
  ...
  {FloatLiteral}                 |
  {DoubleLiteral}                |
  {FloatLiteral}[jJ]             { return token(TokenTypes.NUMBER); }
  ...
  /* identifiers */ 
  {Identifier}"?"                { return token(TokenTypes.TYPE2); }
