...
public class Checksum {
	...
	private final static Logger log = Logger.getLogger(Checksum.class.getName());
	...
	public void compute() {
		...
		checksum = 0xff - checksum;
		 ...
		 log.log(Level.FINEST,"computed checksum is " + ByteUtils.formatByte(checksum));
	}
	...
	public boolean verify() {
		checksum = checksum & 0xff;
		 log.log(Level.FINEST,"verify checksum is " + checksum);
