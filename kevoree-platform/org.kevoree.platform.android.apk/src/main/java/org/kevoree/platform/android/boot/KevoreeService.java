        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Object bootObj = bootClazz.newInstance();
                    ...
                    startM.invoke(bootObj,KevoreeActivity.singleton,getBaseContext(),tkcl.getClusterKCL(),KevoreeActivity.tabs,KevoreeActivity.nodeName);
                } catch (Exception e) {
                    e.printStackTrace();
                }
