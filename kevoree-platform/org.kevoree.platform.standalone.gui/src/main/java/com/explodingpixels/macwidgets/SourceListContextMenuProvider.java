 ...
 * {@link com.explodingpixels.macwidgets.SourceList}, this interface will be notified just prior to a context menu being shown.
 * </p>
 * <p>
...
public interface SourceListContextMenuProvider {
    ...
    /**
     * Called when the user requests that a context-menu be shown on the {@link com.explodingpixels.macwidgets.SourceList} itself.
    ...
    /**
     * Called when the user requests that a context-menu be shown on a {@link com.explodingpixels.macwidgets.SourceListItem}.
    ...
    /**
     * Called when the user requests that a context-menu be shown on a {@link com.explodingpixels.macwidgets.SourceListCategory}.
