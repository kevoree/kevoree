...
public class MacButtonFactory {
    ...
    /**
     * Creates an Apple style gradient button using the given {@link javax.swing.Icon}. The
     * given {@link java.awt.event.ActionListener} will be notified when the button's action
     * fires.
     *
     ...
     * {@link javax.swing.Icon}. The given {@link com.explodingpixels.widgets.PopupMenuCustomizer} will be notified
