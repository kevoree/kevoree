...
public class HudWindow {
     ...
     *
     * @param title the title to use for this window.
     * @param owner the {@link java.awt.Frame} that this HUD is parented to. Can be null.
     */
    ...
    /**
     * Gets the {@link javax.swing.JDialog} backing this {@code HudWindow}.
     *
    ...
    /**
     * Gets the {@link javax.swing.JComponent} to add content to.
     *
    ...
    /**
     * Sets the {@link javax.swing.JComponent} to use as the container for this {@code HudWindow}'s content.
     *
