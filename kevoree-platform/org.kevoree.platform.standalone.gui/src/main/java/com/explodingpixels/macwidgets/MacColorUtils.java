...
public class MacColorUtils {
    ...
    public static Color LEOPARD_BORDER_COLOR = new Color(0xE0E0E0);
    ...
    /**
     * Gets the color used to separate a {@link com.explodingpixels.macwidgets.UnifiedToolBar} from the window content when the
     * window is active.
     *
