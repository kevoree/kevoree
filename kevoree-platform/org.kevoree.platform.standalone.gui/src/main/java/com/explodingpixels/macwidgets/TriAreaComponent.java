...
//        fRightPanelBuilder.getPanel().setBorder(BorderFactory.createLineBorder(Color.GREEN));
    ...
    /**
     * Set's the background {@link com.explodingpixels.painter.Painter} that this {@code TriAreaComponent} uses.
     *
     * @param backgroundPainter the background {@link com.explodingpixels.painter.Painter} that this {@code TriAreaComponent}
     *                          uses.
     */
