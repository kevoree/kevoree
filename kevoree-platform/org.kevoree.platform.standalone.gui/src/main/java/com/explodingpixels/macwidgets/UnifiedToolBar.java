...
public class UnifiedToolBar {
    ...
    /**
     * Installs a custom painter on the given {@link com.explodingpixels.macwidgets.TriAreaComponent} that paints the Mac style
     * unified toolbar gradient on non-Mac platforms as well as Mac platforms running using Java 6.
     *
     * @param unifiedToolBar the {@link com.explodingpixels.macwidgets.TriAreaComponent} to install the custom painter on if
     *                       necessary.
     */
