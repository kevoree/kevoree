...
public class UnifiedToolBar {
	 ...
	 * is dragged, it will move the given {@link java.awt.Window}.
	 * 
	 * @param window
	 ...
	 * {@code UnifiedToolBar}. The returned {@link javax.swing.JComponent} should be added
	...
	/**
	 * Installs a custom painter on the given {@link com.explodingpixels.macwidgets.TriAreaComponent} that
	 ...
	 *            the {@link com.explodingpixels.macwidgets.TriAreaComponent} to install the custom painter on
	 *            if necessary.
	 */
