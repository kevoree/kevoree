 ...
 * {@link javax.swing.JTable} via the
...
public class ITunesTableUI extends BasicTableUI {
	...
	/**
	 * Creates a custom {@link javax.swing.CellRendererPane} that sets the renderer component to be non-opqaque
	 * if the associated row isn't selected. This custom {@code CellRendererPane} is needed because
	 * a table UI delegate has no prepare renderer like {@link javax.swing.JTable} has.
	 */
