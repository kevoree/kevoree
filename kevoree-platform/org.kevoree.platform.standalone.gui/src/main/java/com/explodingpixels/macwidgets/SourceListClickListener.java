...
/**
 * An interface to hook into clicks on {@link com.explodingpixels.macwidgets.SourceListCategory}s and
 * {@link com.explodingpixels.macwidgets.SourceListItem}s. This interface is similar to what
 * {@link com.explodingpixels.macwidgets.SourceListSelectionListener} offers, but provides mouse clicks
...
public interface SourceListClickListener {
    ...
    /**
     * Called when a {@link com.explodingpixels.macwidgets.SourceListItem} is clicked.
     *
    ...
    /**
     * Called when a {@link com.explodingpixels.macwidgets.SourceListCategory} is clicked.
     *
