...
/**
 * A {@link Painter} that can be used to paint the various states of a button. This painter
...
public class ButtonStatePainter<B extends AbstractButton>
    ...
    /**
     * Creates a painter that will always use the given {@link com.explodingpixels.painter.Painter} to
     * paint the button.
     ...
     * @param defaultPainter the {@link com.explodingpixels.painter.Painter} to use when the button has
     *        no specific state.
    ...
    /**
     * An implementation of {@link com.explodingpixels.painter.Painter} that does no painting.
     */
