...
/**
 * An implementation of {@link com.explodingpixels.painter.MacWidgetsPainter} that delegates to given {@code Painter}
 * based on the focused state of the {@link java.awt.Component} supplied in the
...
public class FocusStatePainter implements MacWidgetsPainter<Component> {
	...
	/**
	 * Creates a {@link com.explodingpixels.painter.MacWidgetsPainter} that delegates to the given {@code Painter}s
	 * based on the focus state of the supplied {@link java.awt.Component} or the focus
