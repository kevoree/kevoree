...
/**
 * An implementation of {@link com.explodingpixels.painter.Painter} that calls a series of {@code Painter}s in succession. {@code ComponentPainter}
...
public class CompoundPainter<T> implements Painter<T> {
    ...
    /**
     * Creates a {@link com.explodingpixels.painter.Painter} that calls the given {@code Painter}s in the order they are supplied when
