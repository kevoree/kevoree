...
/**
 * An implementation of {@link com.explodingpixels.painter.MacWidgetsPainter} that calls a series of {@code Painter}s in succession. {@code ComponentPainter}
...
public class CompoundPainter<T> implements MacWidgetsPainter<T> {
    ...
    /**
     * Creates a {@link com.explodingpixels.painter.MacWidgetsPainter} that calls the given {@code Painter}s in the order they are supplied when
