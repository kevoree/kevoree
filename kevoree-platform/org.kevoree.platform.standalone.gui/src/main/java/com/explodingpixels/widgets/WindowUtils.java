...
/**
 * Utility methods for dealing with {@link java.awt.Window}s.
 */
public class WindowUtils {

    /**
     * Try's to make the given {@link java.awt.Window} non-opqaue (transparent) across platforms and JREs.
     ...
     * {@link java.awt.Window}. This will only work when running with JRE 6 update 10 or higher. This method
    ...
    /**
     * Creates and installs a {@link java.awt.event.WindowFocusListener} on the given {@link java.awt.Window} which calls
     ...
     *             {@link com.explodingpixels.widgets.WindowUtils#installJComponentRepainterOnWindowFocusChanged(javax.swing.JComponent)}
     *             method.
     */
    @Deprecated
    ...
    /**
     * {@code true} if the given {@link java.awt.Component}'s has a parent {@link java.awt.Window} (i.e. it's not
     * null) and that {@link java.awt.Window} is currently active (focused).
     *
    ...
    /**
     * Installs a {@link java.awt.event.WindowFocusListener} on the given {@link javax.swing.JComponent}'s parent
     * {@link java.awt.Window}. If the {@code JComponent} doesn't yet have a parent, then the listener will
    ...
    /**
     * Installs a listener on the given {@link javax.swing.JComponent}'s parent {@link java.awt.Window} that repaints
    ...
    /**
     * Creates an {@link javax.swing.event.AncestorListener} that installs a weakly referenced version of the given
     * {@link java.awt.event.WindowFocusListener} when the given {@link javax.swing.JComponent}'s parent changes.
     */
    ...
    /**
     * Creates a {@link java.awt.event.WindowFocusListener} that calls repaint on the given {@link javax.swing.JComponent} when
