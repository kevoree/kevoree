...
/**
 * A {@link com.explodingpixels.widgets.plaf.ScrollBarSkin} with the buttons placed at the bottom or right of the scroll bar.
 */
public class ButtonsTogetherScrollBarSkin implements ScrollBarSkin {
     ...
     * @param trackPainter          the {@link com.explodingpixels.painter.Painter} to use to paint the track.
     * @param scrollThumbPainter    the {@link com.explodingpixels.painter.Painter} to use to paint the scroll thumb.
