...
public class TreeUtils {
    ...
    /**
     * Set's the collapsed icon to use for the given {@link javax.swing.JTree} if that
     * tree's UI delegate exetends from {@link javax.swing.plaf.basic.BasicTreeUI}. If the given tree's
     ...
     * @see javax.swing.plaf.basic.BasicTreeUI#setCollapsedIcon(javax.swing.Icon)
     */
    ...
    /**
     * Set's the expanded icon to use for the given {@link javax.swing.JTree} if that
     * tree's UI delegate extends from {@link javax.swing.plaf.basic.BasicTreeUI}. If the given tree's
     * UI delegate does not extend from {@code BasicTreeUI} then the given
     * tree will not be changed.
     *
     * @param tree the tree to set the expanded icon for.
     * @param icon the new collapsed icon to use.
     * @see javax.swing.plaf.basic.BasicTreeUI#setExpandedIcon(javax.swing.Icon)
     */
    ...
    /**
     * Set's the left indent in pixels to use for the given {@link javax.swing.JTree}'s
     ...
     * @see javax.swing.plaf.basic.BasicTreeUI#setLeftChildIndent(int)
     */
    ...
    /**
     * Set's the right indent in pixels to use for the given {@link javax.swing.JTree}'s
     ...
     * @param indent the new left indent in pixels.
     * @see javax.swing.plaf.basic.BasicTreeUI#setRightChildIndent(int)
     */
