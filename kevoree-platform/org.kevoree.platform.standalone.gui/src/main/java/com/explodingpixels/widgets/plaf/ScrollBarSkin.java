...
/**
 * An interface that allows implementors to control the appearance of a {@link javax.swing.JScrollBar}.
 */
public interface ScrollBarSkin {

    /**
     * Called once at the begining of the skin's life cycle. Implementors should add components
     * that will later be controlled in {@link #layoutTrackOnly(javax.swing.JScrollBar, com.explodingpixels.widgets.plaf.ScrollBarOrientation)}
     * and {@link #layoutEverything(javax.swing.JScrollBar, com.explodingpixels.widgets.plaf.ScrollBarOrientation)}.
     *
     * @param scrollBar the {@link javax.swing.JScrollBar} that the skin will be painting.
     */
     ...
     *
     * @param decrementMoustListener the {@link java.awt.event.MouseListener} to be notified when a control is
     *                               pressed that should result in the scroll bar's value decrementing.
     * @param incrementMouseListener the {@link java.awt.event.MouseListener} to be notified when a control is
     ...
     * {@link javax.swing.JScrollBar} has been set to {@link javax.swing.JScrollPane#VERTICAL_SCROLLBAR_ALWAYS}
     ...
     *
     * @param scrollBar   the {@link javax.swing.JScrollBar} that the skin is painting.
     ...
     * {@link javax.swing.JScrollBar}. For vertical scroll bars, this value will drive the width. For horiztonal
     ...
     * associated {@link javax.swing.JScrollBar}'s {@link javax.swing.BoundedRangeModel} is updated.
     *
     ...
     * bounds of the associated {@link javax.swing.JScrollBar}, but only the bounds that are valid for the
