package org.kevoree.library.jabase.jenkins_master;
 ...
 */
@ComponentType
public class JenkinsMaster extends AbstractComponentType {
	private static final Logger logger = LoggerFactory.getLogger(JenkinsMaster.class);
