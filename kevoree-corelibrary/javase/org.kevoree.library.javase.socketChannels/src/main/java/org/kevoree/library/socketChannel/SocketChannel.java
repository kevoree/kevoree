...
public class SocketChannel extends AbstractChannelFragment implements Runnable {
    ...
    private final Semaphore sempool = new Semaphore(maxConcurrentClients);
    ...
    public void nodeDown(Socket client){
        ...
        logger.debug("Node is down " + client.getLocalAddress() + ":" + client.getPort());
    ...
    public void run() {
        ...
        try
        {
            ...
            logger.debug("Running Socket server <" + getNodeName() + "> port <" + portServer + ">");
