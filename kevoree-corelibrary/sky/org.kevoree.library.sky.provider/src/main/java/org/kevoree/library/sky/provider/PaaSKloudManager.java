...
@Requires({
		@RequiredPort(name = "delegate", type = PortType.SERVICE, className = PaaSService.class)
})
@ComponentType
public class PaaSKloudManager extends AbstractComponentType implements PaaSManagerService {
