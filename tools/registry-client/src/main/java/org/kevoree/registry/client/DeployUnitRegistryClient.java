 ...
 */
public interface DeployUnitRegistryClient extends RegistryClient {

    // === GET ===
    default HttpResponse<RDeployUnit[]> getAllDus() throws UnirestException {
        return Unirest.get(this.baseUrl() + "/api/dus")
                .asObject(RDeployUnit[].class);
    }

    default HttpResponse<RDeployUnit[]> getAllDus(String namespace) throws UnirestException {
        return Unirest.get(this.baseUrl() + "/api/namespaces/{namespace}/dus")
                .routeParam("namespace", namespace)
                .asObject(RDeployUnit[].class);
    }

    default HttpResponse<RDeployUnit[]> getAllDus(String namespace, String tdefName) throws UnirestException {
    ...
    default HttpResponse<RDeployUnit[]> getAllDus(String namespace, String tdefName, long tdefVersion) throws UnirestException {
    ...
    default HttpResponse<RDeployUnit[]> getReleasesDus(String namespace, String tdefName, long tdefVersion) throws UnirestException {
        return Unirest.get(this.baseUrl() + "/api/namespaces/{namespace}/tdefs/{tdefName}/{tdefVersion}/dus")
                .routeParam("namespace", namespace)
                .routeParam("tdefName", tdefName)
                .routeParam("tdefVersion", String.valueOf(tdefVersion))
    ...
    default HttpResponse<RDeployUnit[]> getSpecificDus(String namespace, String tdefName, long tdefVersion, Map<String, Object> filters) throws UnirestException {
    ...
    // === POST ===
    default HttpResponse<RDeployUnit> createDu(String namespace, String name, long version, RDeployUnit du) throws UnirestException {
    ...
    // === PUT ===
    default HttpResponse<RDeployUnit> updateDu(RDeployUnit du) throws UnirestException {
    ...
    // === DELETE ===
    default HttpResponse<JsonNode> deleteDu(String namespace, String tdefName, long tdefVersion, String name, String version, String platform) throws UnirestException {
