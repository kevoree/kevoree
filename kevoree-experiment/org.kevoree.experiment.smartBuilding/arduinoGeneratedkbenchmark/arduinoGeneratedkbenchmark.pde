...
const prog_char init_ch[] PROGMEM = "ch";
const prog_char init_t1[] PROGMEM = "t1";
const prog_char init_li[] PROGMEM = "li";
PROGMEM const char * init_tables[] = {init_ch,init_t1,init_li};
...
save2Memory(sepAdminChar);
        ...
        saveAIN_CMD(instNameBuf, 0, "period=50");                                             
save2Memory(sepAdminChar);
