...
public class ForkedGregClient {

    public ForkedGregClient(ForkedConfiguration _conf) {
        conf = _conf;
        pushMessages = new Thread("GregPushMessages") {
            public void run() {
                pushCurrentMessages();
            }
        };
        ...
        pushMessages.start();
        initCalibration = new Thread("GregInitiateCalibration") {
            public void run() {
                initiateCalibration();
            }
        };
    ...
    private Thread pushMessages = null;
    private Thread initCalibration = null;
    ...
    private ForkedConfiguration conf = null;

    private final UUID OUR_UUID = UUID.randomUUID();
    ...
    private boolean writeRecordsBatchTo(OutputStream stream) throws IOException {
