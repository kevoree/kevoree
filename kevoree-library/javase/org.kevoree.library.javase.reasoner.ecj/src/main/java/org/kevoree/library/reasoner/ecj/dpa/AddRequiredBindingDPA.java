...
public class AddRequiredBindingDPA implements DPA {
    ...
    public final static String scriptPath = "target/classes/addBinding.kevs";
                ...
                for (Port myPort : componentInstance.getRequired()) {
                    for (Channel myChannel : myModel.getHubs()) {
                        if (!existBinding(myModel, myPort, myChannel)) {
                            ...
                            myMap.put(AddRequiredBindingDPA.portName,
                                    (NamedElement) myPort.getPortTypeRef());
                            myMap.put(AddRequiredBindingDPA.channelName,
                                    (NamedElement) myChannel);
                            myMap.put(AddRequiredBindingDPA.componentName,
                                    (NamedElement) componentInstance);
                            myMap.put(AddRequiredBindingDPA.nodeName,
