 ...
 */
@Requires({
    @RequiredPort(name = "r1", type = PortType.MESSAGE, optional = false, needCheckDependency = false),
    @RequiredPort(name = "r2", type = PortType.MESSAGE, optional = false, needCheckDependency = false)
})
