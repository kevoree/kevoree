...
public class Tester {
    ...
    public static void main(String[] args){
        ...
        String modelString = "/Users/ffouquet/Documents/DEV/dukeboard_github/kevoree/kevoree-library/arduino/org.kevoree.library.arduino.nodeType2/src/test/resources/models/LCDSimple.kev";
        ...
        node.getDictionary().put("boardPortName","/dev/tty.usbmodem621");
