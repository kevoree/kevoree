...
void setup(){
Serial.begin(9600);
int indexhub1928280365 = createInstance(2,"hub1928280365","");
int indextimer1 = createInstance(0,"timer1","period=1000,");
int indexled1 = createInstance(1,"led1","pin=11,");
bind(indextimer1,indexhub1928280365,0);
bind(indexled1,indexhub1928280365,3);
//STATE RECOVERY                                                         
