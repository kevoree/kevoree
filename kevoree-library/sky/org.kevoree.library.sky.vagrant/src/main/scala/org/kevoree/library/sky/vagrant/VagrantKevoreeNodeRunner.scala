package org.kevoree.library.sky.vagrant
 ...
 * @version 1.0
 */
class VagrantKevoreeNodeRunner (var nodeName: String, bootStrapModel: String) extends KevoreeNodeRunner(nodeName, bootStrapModel) {
  private val logger: Logger = LoggerFactory.getLogger(classOf[VagrantKevoreeNodeRunner])
